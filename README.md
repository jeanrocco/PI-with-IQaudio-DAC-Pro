...
One last thing, let's get rid of pulseaudio ... it breaks-up  things ...
 ...
 Then on any PC or MAC computer, from any browser, again connect to the "spotify web player" URL, and at the bottom right hand corner, click the "speaker box like icon" displaying "connect to a device" and click "web player (Chrome)" which is still running on your PI. From now on, any tunes you choose will be played on the Pi's DAC ... ain't that cute !
